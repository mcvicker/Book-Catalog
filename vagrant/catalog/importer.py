...
# based on the book's title, it finds each book
# using google books API and finds an appropriate
# image and description for each book.
# It imports the fields from the TSV and the API
# into the bookcatalog database.
